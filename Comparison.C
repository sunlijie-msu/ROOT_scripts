...
void Comparison()
{
	for(int iscan=0;iscan<62;iscan++){//portal, scan many simulation rootfile with different gamma energies 4238 i=35
		...
		//Robertson
		sprintf(tname,"%s%.2f%s%d%s%.1f%s%.1f%s%d%s%s%s%d%s%d%s%d%s%.1f%s","D:/X/out/Figure_ungated/Sim25Si_rel_T",T_Lifetime,"_Step",NumberofSteps,"_Emax",centroid+iscan*binwidth,"_Emean",E0_gamma+iscan*binwidth,"_feed",nBranches,"_En",pname,"SP",Flag_SP,"_Det",Flag_Det,"_Ang",Flag_Ang,"_binwid",binwidth,"_P10_Sun_Robertson.png");
		//Robertson RIBLL
