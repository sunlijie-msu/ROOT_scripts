...
const int nBranches=14;                  //13,19;2,3 Number of proton Branches feeding daughter modify
TH1F *proton_branch[nBranches],*proton_copy[nBranches],*maximum_branch[nBranches],*totalmax;
//Robertson 1369-keV γ 20
...
void Comparison_1369_gated_Tho()
{
	for(int iscan=34;iscan<35;iscan++){//portal, scan many simulation rootfile with different gamma energies 1369 i=34; 2754 i=29; 2870 i=30; 4238 i=28
