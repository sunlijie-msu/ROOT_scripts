...
void Comparison_1369_gated_Tho_rel()
{
	for(int iscan=34;iscan<35;iscan++){//portal, scan many simulation rootfile with different gamma energies 1369 i=37; 2754 i=35; 2870 i=34; 4238 i=36
		...
		fin_data = new TFile("D:/X/out/Si25/100eV-bin-gated_sun_25Si_jason0.5.root"); //Rootfile with Experimental Data Histogram gated
