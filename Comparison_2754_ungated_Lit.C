...
double feed[nBranches]={0.526460, 0.265243,	0.169135,	0.039163};		//beta feeding intensity of each proton, if the sum of all the feeding intensities is less than 1, the extra events will assume a En=0.
//Lit 2870-keV γ 3
...
void Comparison_2754_ungated_Lit()
{
	for(int iscan=30;iscan<31;iscan++){//portal, scan many simulation rootfile with different gamma energies 1369 i=34; 2754 i=29; 2870 i=30; 4238 i=27
		...
		//sprintf(tname,"%s%.2f%s%d%s%.1f%s%.1f%s%d%s%s%s%d%s%d%s%d%s%d%s%d%s%d%s%.1f%s","D:/X/out/Figure_ungated/Sim25Si_T",T_Lifetime,"_Step",NumberofSteps,"_Emax",centroid+iscan*binwidth,"_Emean",E0_gamma+iscan*binwidth,"_feed",nBranches,"_En",pname,"SP",Flag_SP,"_Det",Flag_Det,"_Ang",Flag_Ang,"_st",Flag_st,"_sig",Flag_sig,"_tau",Flag_tau,"_binwid",binwidth,"_P10_Sun_Thomas");
		//Lit save figure
