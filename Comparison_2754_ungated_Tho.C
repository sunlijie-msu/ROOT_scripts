...
void Comparison_2754_ungated_Tho()
{
	for(int iscan=30;iscan<31;iscan++){//portal, scan many simulation rootfile with different gamma energies 1369 i=34; 2754 i=29; 2870 i=30; 4238 i=28
		...
		sprintf(tname,"%s%.2f%s%d%s%.1f%s%d%s%s%s%d%s%d%s%d%s%d%s%d%s%d%s%.1f%s","D:/X/out/Thomas/Sim25Si_T",T_Lifetime,"_Step",NumberofSteps,"_Eg",E0_gamma,"_feed",nBranches,"_En",pname,"SP",Flag_SP,"_Det",Flag_Det,"_Ang",Flag_Ang,"_st",Flag_st,"_sig",Flag_sig,"_tau",Flag_tau,"_binwid",0.1,"_P10_Sun_Thomas_baseline_August");
		//Robertson
