...
const double minrangezoom=Ebin_gamma-40; //shorter range to calculate chi2 25 30 30 40 modify
const double maxrangezoom=Ebin_gamma+40; //shorter range to calculate chi2 25 30 30 40
...
double feed[nBranches]={0.2987213,	0.6323435,	0.0573889,	0.0115463};		//beta feeding intensity of each proton, if the sum of all the feeding intensities is less than 1, the extra events will assume a En=0.
//Lit 2870-keV γ 2
...
void Comparison_4238_ungated_Lit()
{
	for(int iscan=27;iscan<28;iscan++){//portal, scan many simulation rootfile with different gamma energies 1369 i=34; 2754 i=29; 2870 i=30; 4238 i=27
