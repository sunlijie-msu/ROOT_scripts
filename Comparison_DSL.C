...
float bkgDown=0.99;
float bkgUp=1.00; // if you set bkgDown and bkgUp the same value, the bkg will be set to zero in minimization, which is wrong
double ULbkg=1.1;
double LLbkg=0.9;
...
// 	const int up=406; //E0_gamma+up has to be even number, if E0 is odd, up should be odd 4156+110=4266
// 	const int down=-182; //E0_gamma-down has to be even number, if E0 is odd, down should be odd 4156+450=4606
// 	const int Ea=39;
// 	double T0_lifetime = 0;
// 	int Lifetimestep = 1;
...
//	int ifolder =0; flag_Eg = centroid;//-Eg_uncertainty;
	{
		...
		{
			for (flag_SP = 0.8; flag_SP <= 1.2; flag_SP += 0.2) // for (flag_SP = 0.8; flag_SP <= 1.2; flag_SP += 0.2) for 1248 and 2234, 0.9,1.1,0.1 for others
			{
				for (flag_AC = 0.0; flag_AC <= 0.0; flag_AC += 1.0) // for (flag_AC = -0.0; flag_AC <= 0.0; flag_AC += 1.0) for 1248 and 2234, -1.0,1.0,1.0 for others
				{
...
//	for(int iscantau=0;iscantau<=100;iscantau+=10)// supplemental step 2838, 4270, 3541
// 					int iscantau = 400;
