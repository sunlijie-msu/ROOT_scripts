...
using namespace std;
//main_readhists; fcn(); comparehists(); main_draw_save;//search m o d i f y to change peak; Constant bkg model, not for final results.
// could add two bumps around 1248 with free parameters (optional). Three peaks + linear fline two-part bkg. Bumps have been switched off.
