...
const double minrangezoom=Ebin_gamma-30; //shorter range to calculate chi2 25 30 30 40 modify RIBLL
const double maxrangezoom=Ebin_gamma+20; //shorter range to calculate chi2 25 30 30 40
