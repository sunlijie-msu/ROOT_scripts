...
const double minrangezoom=Ebin_gamma-35; //shorter range to calculate chi2 25 30 30 40 modify RIBLL
...
void Comparison()
{
	for(int iscan=0;iscan<10;iscan++){//portal, scan many simulation rootfile with different gamma energies 4238 i=35 RIBLL
