...
TFile* fin = TFile::Open("F:/out/G4_rootfiles_with_tree_Eg4156/S31_Gamma4156_Eg4155.84_Tau0.0_SP1.00_AC0.0_all.root");
...
TFile* fout = new TFile("F:/out/G4_rootfiles_with_tree_Eg4156/Fakepeak_S31_Gamma4156_Eg4155.84_Tau0.0_SP1.00_AC0.0.root", "RECREATE");
hfakepeak->Write();
fout->Close();

//Get rid of G4 background below the peak
TFile* fin1 = TFile::Open("F:/out/G4_rootfiles_with_tree_Eg4156/Fakepeak_S31_Gamma4156_Eg4155.84_Tau0.0_SP1.00_AC0.0.root");
...
hfakepurepeak->Draw();
TFile* fout2 = new TFile("F:/out/G4_rootfiles_with_tree_Eg4156/Fakepurepeak_S31_Gamma4156_Eg4155.84_Tau0.0_SP1.00_AC0.0.root", "RECREATE");
hfakepurepeak->Write();
fout2->Close();

//3) Combine the fake peak and fake background
TFile* fin2 = TFile::Open("F:/out/G4_rootfiles_with_tree_Eg4156/Fakebackground.root");
TFile* fin3 = TFile::Open("F:/out/G4_rootfiles_with_tree_Eg4156/Fakepurepeak_S31_Gamma4156_Eg4155.84_Tau0.0_SP1.00_AC0.0.root");
...
hfakedata->Draw("");
TFile* fout3 = new TFile("F:/out/G4_rootfiles_with_tree_Eg4156/Fakedata_S31_Gamma4156_Eg4155.84_Tau0.0_SP1.00_AC0.0_manipulated.root", "RECREATE");
hfakedata->Write();
fout3->Close();
