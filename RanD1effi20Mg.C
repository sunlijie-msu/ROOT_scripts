...
#include <time.h>
using namespace std;
void RanD1effi20Mg()//能量相关，从D1发射一定能量质子，被各探测器探测到的概率
{
	...
	sprintf(anarootname,"V:/RIBLL2015/data20/Mg20calabcd_0347_0622T.root");
...
// 	}
	sprintf(simurootname,"%s","V:/RIBLL2015/data20/Mg20simulate.root");
