...
#include <time.h>
using namespace std;
void Ranprotonesc()//能量无关，全穿出，周边立体角
{
...
// 			z0=z1D1+pzD1->GetRandom()/1000;
			...
			if(tan(acos(costheta))>-1000&&tan(acos(costheta))<1000&&x<x2D1&&x>x1D1&&y<y2D1&&y>y1D1)//DSSD1
			{
				h3->Fill(y,x,z1D1);
				h2D1->Fill(x,y);
				h1D1->Fill(y);
			...
			if(tan(acos(costheta))>-1000&&tan(acos(costheta))<1000&&x<x2Q1&&x>x1Q1&&y<y2Q1&&y>y1Q1)//QSD1
			{
				h3->Fill(y,x,z1Q1);
				h2Q1->Fill(x,y);
				h1Q1->Fill(y);
			...
			if(tan(acos(costheta))>-1000&&tan(acos(costheta))<1000&&x<x2Q2&&x>x1Q2&&y<y2Q2&&y>y1Q2)//QSD2
			{
				h3->Fill(y,x,z1Q2);
				h2Q2->Fill(x,y);
				h1Q2->Fill(y);
		...
		cout<<"cntD1=	"<<cntD1/2<<endl;
		cout<<"cntQ1=	"<<cntQ1/2<<endl;
		cout<<"cntQ2=	"<<cntQ2/2<<endl;
		cout<<"cntQU=	"<<cntQU/2<<endl;
		cout<<"cntQD=	"<<cntQD/2<<endl;
		cout<<"cntQL=	"<<cntQL/2<<endl;
		cout<<"cntQR=	"<<cntQR/2<<endl;
