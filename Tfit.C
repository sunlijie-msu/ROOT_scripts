...
TFile* _file0 = TFile::Open("S31_Gamma4156_Eg4155.84_Tau0.0_SP1.20_AC0.0_all.root");
TH1F* Eg = new TH1F("Eg", "Eg", 8000, 0., 8000);
tree->Draw("Clovere>>Eg", "Clovere>0&&Clovere<8000&&DSSD1e+DSSD2e>10000&&DSSD1e>100&&DSSD2e>100", "");
TFile* fout = new TFile("S31_Gamma4156_Eg4155.84_Tau0.0_SP1.20_AC0.0.root", "RECREATE");
Eg->Write();
fout->Close();
...
T888->Draw("Si0BHC[0]+Si0BHC[1]+Si0BHC[2]+Si0BHC[3]+Si0BHC[4]+Si0BHC[5]+Si0BHC[6]+Si0BHC[7]+Si0BHC[8]+Si0BHC[9]+Si0BHC[20]+Si0BHC[11]+Si0BHC[12]+Si0BHC[13]+Si0BHC[14]+Si0BHC[15]","Si0BHC[0]+Si0BHC[1]+Si0BHC[2]+Si0BHC[3]+Si0BHC[4]+Si0BHC[5]+Si0BHC[6]+Si0BHC[7]+Si0BHC[8]+Si0BHC[9]+Si0BHC[20]+Si0BHC[11]+Si0BHC[12]+Si0BHC[13]+Si0BHC[14]+Si0BHC[15]>1000&&DE1C>218&&DE1C<243&&TOFC>183&&TOFC<188"); //27S 150
