...
#include "TLegend.h"
using namespace std;
void graphlogpol6fit_band_four23Alpoints()// graph-logpol6 fit the simulated SeGA efficiency points to get the curve (with colored bands)
{
	time_t tim;
	struct tm *at;
	char now[80];
...
//  	for(jj=0;jj<Npoint;jj++){	energy_point[jj]=jj*10;}
	...
	//source at 23Al SeGA simulated points
	energy[0][0]=451;	energyerr[0][0]=0.15;	eff[0][0]=0.0479;	efferr[0][0]=0.0023;
	energy[0][1]=1599;	energyerr[0][1]=2;	eff[0][1]=0.0253839;	efferr[0][1]=0.0012617;
	energy[0][2]=2904;	energyerr[0][2]=3;	eff[0][2]=0.0162702;	efferr[0][2]=0.0008749;
	energy[0][3]=7801;	energyerr[0][3]=2;	eff[0][3]=0.0056589;	efferr[0][3]=0.0002885;
