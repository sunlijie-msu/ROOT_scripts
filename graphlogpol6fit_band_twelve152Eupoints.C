...
#include "TLegend.h"
using namespace std;
void graphlogpol6fit_band_twelve152Eupoints()// graph-logpol6 fit the simulated SeGA efficiency points to get the curve (with colored bands)
{
	time_t tim;
	struct tm *at;
	char now[80];
...
//  	for(jj=0;jj<Npoint;jj++){	energy_point[jj]=jj*10;}
	...
	//source at 0,0,20 SeGA upstream simulated points
// 	energy[0][0]=245;	energyerr[0][0]=0.0008;	eff[0][0]=0.0393787;	efferr[0][0]=0.0003990;
// 	energy[0][1]=344;	energyerr[0][1]=0.0012;	eff[0][1]=0.0307592;	efferr[0][1]=0.0002099;
// 	energy[0][2]=411;	energyerr[0][2]=0.0012;	eff[0][2]=0.0269066;	efferr[0][2]=0.0005973;
// 	energy[0][3]=444;	energyerr[0][3]=0.003;	eff[0][3]=0.0254272;	efferr[0][3]=0.0004736;
// 	energy[0][4]=779;	energyerr[0][4]=0.0024;	eff[0][4]=0.0176528;	efferr[0][4]=0.0001896;
// 	energy[0][5]=867;	energyerr[0][5]=0.003;	eff[0][5]=0.0167909;	efferr[0][5]=0.0003188;
// 	energy[0][6]=964;	energyerr[0][6]=0.018;	eff[0][6]=0.0156949;	efferr[0][6]=0.0001662;
// 	energy[0][7]=1112;	energyerr[0][7]=0.003;	eff[0][7]=0.0144493;	efferr[0][7]=0.0001645;
// 	energy[0][8]=1213;	energyerr[0][8]=0.0011;	eff[0][8]=0.0130671;	efferr[0][8]=0.0005053;
// 	energy[0][9]=1299;	energyerr[0][9]=0.008;	eff[0][9]=0.0129044;	efferr[0][9]=0.0004175;
// 	energy[0][10]=1408;	energyerr[0][10]=0.003;	eff[0][10]=0.0123127;	efferr[0][10]=0.0001226;


	//source at 0,0,0 SeGA center simulated points
// 	energy[0][0]=245;	energyerr[0][0]=0.0008;	eff[0][0]=0.1238640;	efferr[0][0]=0.0008454;
// 	energy[0][1]=344;	energyerr[0][1]=0.0012;	eff[0][1]=0.0980357;	efferr[0][1]=0.0005286;
// 	energy[0][2]=411;	energyerr[0][2]=0.0012;	eff[0][2]=0.0845463;	efferr[0][2]=0.0010811;
// 	energy[0][3]=444;	energyerr[0][3]=0.003;	eff[0][3]=0.0819520;	efferr[0][3]=0.0008925;
// 	energy[0][4]=779;	energyerr[0][4]=0.0024;	eff[0][4]=0.0553781;	efferr[0][4]=0.0003950;
// 	energy[0][5]=867;	energyerr[0][5]=0.003;	eff[0][5]=0.0513063;	efferr[0][5]=0.0005888;
// 	energy[0][6]=964;	energyerr[0][6]=0.018;	eff[0][6]=0.0482907;	efferr[0][6]=0.0003436;
// 	energy[0][7]=1112;	energyerr[0][7]=0.003;	eff[0][7]=0.0435366;	efferr[0][7]=0.0003287;
// 	energy[0][8]=1213;	energyerr[0][8]=0.0011;	eff[0][8]=0.0420141;	efferr[0][8]=0.0009036;
// 	energy[0][9]=1299;	energyerr[0][9]=0.008;	eff[0][9]=0.0396752;	efferr[0][9]=0.0007444;
// 	energy[0][10]=1408;	energyerr[0][10]=0.003;	eff[0][10]=0.0369031;	efferr[0][10]=0.0002534;


	//source at 0,0,-20 SeGA downstream simulated points
// 	energy[0][0]=245;	energyerr[0][0]=0.0008;	eff[0][0]=0.0394453;	efferr[0][0]=0.0003996;
// 	energy[0][1]=344;	energyerr[0][1]=0.0012;	eff[0][1]=0.0311317;	efferr[0][1]=0.0002117;
// 	energy[0][2]=411;	energyerr[0][2]=0.0012;	eff[0][2]=0.0276710;	efferr[0][2]=0.0006025;
// 	energy[0][3]=444;	energyerr[0][3]=0.003;	eff[0][3]=0.0263488;	efferr[0][3]=0.0004839;
// 	energy[0][4]=779;	energyerr[0][4]=0.0024;	eff[0][4]=0.0182423;	efferr[0][4]=0.0001929;
// 	energy[0][5]=867;	energyerr[0][5]=0.003;	eff[0][5]=0.0166777;	efferr[0][5]=0.0003199;
// 	energy[0][6]=964;	energyerr[0][6]=0.018;	eff[0][6]=0.0159446;	efferr[0][6]=0.0001678;
// 	energy[0][7]=1112;	energyerr[0][7]=0.003;	eff[0][7]=0.0146187;	efferr[0][7]=0.0001655;
// 	energy[0][8]=1213;	energyerr[0][8]=0.0011;	eff[0][8]=0.0133640;	efferr[0][8]=0.0005122;
// 	energy[0][9]=1299;	energyerr[0][9]=0.008;	eff[0][9]=0.0135417;	efferr[0][9]=0.0004258;
// 	energy[0][10]=1408;	energyerr[0][10]=0.003;	eff[0][10]=0.0124436;	efferr[0][10]=0.0001234;
...
// 		if(i==0)peaknum=nummax-4;
		...
		for(ii=0;ii<Npoint;ii++)
		{
			...
			outfile<<"Eg=	"<<energy_point[ii]<<"	eff=	"<<logpol6->Eval(energy_point[ii])<<"	relative residual=	"<<residual[i][ii]<<endl;
		}
