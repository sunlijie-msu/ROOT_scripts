...
#include "TLegend.h"
using namespace std;
void graphpol0ratio_band_four23Alpoints()// graph-pol0 fit find the scaling factor by fitting the ratios of SeGA efficiency data points to simulation points.
{
	time_t tim;
	struct tm *at;
	char now[80];
...
//	par[0][7]=1;	parerr[0][7]=0.1;//C useless for now
	...
	energy[0][0]=451;	energyerr[0][0]=0.15;	eff[0][0]=1.0157;	efferr[0][0]=0.0700;
	energy[0][1]=1599;	energyerr[0][1]=2;	eff[0][1]=0.9653961;	efferr[0][1]=0.0696217;
	energy[0][2]=2904;	energyerr[0][2]=3;	eff[0][2]=1.1356529;	efferr[0][2]=0.1272925;
	energy[0][3]=7801;	energyerr[0][3]=2;	eff[0][3]=0.9689630;	efferr[0][3]=0.1018451;
...
// 		if(i==0)peaknum=nummax-4;
		...
		graph1[i]->GetYaxis()->SetRangeUser(0.5,1.3);
