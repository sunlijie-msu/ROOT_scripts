...
//  	for(jj=0;jj<Npoint;jj++){	energy_point[jj]=jj*10;}
	...
	par[0][5]=-0.01127452;	parerr[0][5]=0.00000751;
	par[0][4]=0.12441435;	parerr[0][4]=0.00006701;
	par[0][3]=-0.60251358;	parerr[0][3]=0.00055137;
	par[0][2]=1.12688630;	parerr[0][2]=0.00439555;
	par[0][1]=-0.90164065;	parerr[0][1]=0.03312560;
	par[0][0]=0.92697569;	parerr[0][0]=0.18861573;
	...
	//data points 23Al
	energy[0][0]=451;	energyerr[0][0]=0.15;	eff[0][0]=0.0487;	efferr[0][0]=0.00237;
	energy[0][1]=1599;	energyerr[0][1]=2;	eff[0][1]=0.0245055;	efferr[0][1]=0.0012805;
	energy[0][2]=2904;	energyerr[0][2]=3;	eff[0][2]=0.0184773;	efferr[0][2]=0.0018172;
	energy[0][3]=7801;	energyerr[0][3]=2;	eff[0][3]=0.0054833;	efferr[0][3]=0.0005040;
