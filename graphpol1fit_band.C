...
#include "TLegend.h"
using namespace std;
void graphpol1fit_band()// the best band explanation
...
// 	double energyliterr[6]={0.15, 0.005, 2, 0.010, 3, 2};//23Al
	...
	const int Npoint=5;
	double energy_point[Npoint] = {1248,2234,3076,4971,5156};// set location of point for single value modify
...
//		graph1[idetector]->GetYaxis()->SetRangeUser(0.9,1.5);
		...
		{
			outfile<<"GRIFFIN_"<<idetector<<"	Eg=	"<<energy_point[iipeak]<<"	sig=	"<<pol1->Eval(energy_point[iipeak])<<endl;
