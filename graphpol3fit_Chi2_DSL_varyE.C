...
#include "TLegend.h"
using namespace std;
void graphpol3fit_Chi2_DSL_varyE()// graph-pol3 fit Chi2
{
	time_t tim;
	struct tm *at;
	char now[80];
...
// 	for(jj=0;jj<Npoint;jj++){	energy_point[jj]=jj*40;}
	...
	double Tau=2600;//DSLmodify 1200, 260, 
...
//		sprintf(b_name,"%s%d%s%d%s","D:/X/out/DSL/Chi2_Ea",Ea,"Eg",Eg,"projection_vEg.dat");//DSLmodify
		sprintf(b_name,"%s%d%s%d%s%.0f%s","D:/X/out/DSL/Chi2_Ea",Ea,"Eg",Eg,"Tau",Tau,"slice_vEg.dat");
		cout<<b_name<<endl;
...
// 		if(i==0)peaknum=nummax-4;
		...
		sprintf(hcali_name,"%s%d%s%d%s","Chi2_Ea",Ea,"Eg",Eg,"vEg");
		...
		if(Eg==1248){ minrange=1242; maxrange=1252; }//DSLmodify
		if(Eg==2234){ minrange=2224; maxrange=2240; }
		if(Eg==3076){ minrange=3069; maxrange=3085; }
		if(Eg==4971){ minrange=4961; maxrange=4979; }
		if(Eg==5156){ minrange=5146; maxrange=5172; }
...
// 		pol3->SetParameter(5,-1.94487760396441E-01);
// 		pol3->SetParameter(4,1.20676089831191E+03);
// 		pol3->SetParameter(3,-2.99500517881828E+06);
// 		pol3->SetParameter(2,3.71647522991241E+09);
// 		pol3->SetParameter(1,-2.30580264626732E+12);
// 		pol3->SetParameter(0,5.72216193814757E+14);
...
// 		pol3->SetParameter(6,4.63064233713339E-04);
// 		pol3->SetParameter(5,-6.19927835329918E+00);
// 		pol3->SetParameter(4,3.45803467261303E+04);
// 		pol3->SetParameter(3,-1.02876416307665E+08);
// 		pol3->SetParameter(2,1.72156881480732E+11);
// 		pol3->SetParameter(1,-1.53649525775788E+14);
//  	pol3->SetParameter(0,5.71381755372138E+16);
...
// 		pol3->SetParameter(6,-0.00000003962278);
// 		pol3->SetParameter(5,0.00122413264673);
// 		pol3->SetParameter(4,-15.75798079119190);
// 		pol3->SetParameter(3,108186.02957838600000);
// 		pol3->SetParameter(2,-417795857.200374);
// 		pol3->SetParameter(1,860509384185.806);
// 		pol3->SetParameter(0,-738474766394845);
