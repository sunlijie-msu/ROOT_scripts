...
#include "TLegend.h"
using namespace std;
void peakfit_4gausnpol1_pxct_lege() // get histogram and Gausn fit some peaks
{
	...
	double fitrange_min = 19, fitrange_max = 22;
	...
	TF1* gtotal = new TF1("gtotal", "pol1(0) + gausn(2) + gausn(5) + gausn(8) + gausn(11)", 0, 100);
	gtotal->SetNpx(20000);
	// Create an array to hold the parameters
	double params[] = { 100, 2, 300, 20.784, 0.12, 2000, 21.099, 0.12, 100, 21.342, 0.12, 4000, 21.491, 0.12};
