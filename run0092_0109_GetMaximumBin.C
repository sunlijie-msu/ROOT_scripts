/*
 * For PXCT run0092_0095_0100_0109. Output Max bin per 2e6 events so that to do gain matching in Excel.
...
void run0092_0109_GetMaximumBin()
{
	...
	for (int iFile = 0; iFile < 260; iFile++) // 260 if Which_data = 2
	{
...
// 		if (Which_data == 2)
// 		{
// 			slope_msd12_e = 1; // based on run0092-0109 241Am Ea_loss=1791 keV
// 			slope_msd26_e = 1; // based on run0092-0109 241Am Ea_loss=3626 keV
// 		}
// 		if (Which_data == 3)
// 		{
...
// 		hmsd12_e = new TH1D("hmsd12_e", "hmsd12_e", 60000, 0, binmax_msd12); // 60000 channels, 126 eV per channel
		hmsd26_e = new TH1D("hmsd26_e", "hmsd26_e", 20000, 0, 60000); // 60000 channels, 3 bins per channel for getting the maximum bin
...
// 		htiming_msd12_msd26 = new TH1D("htiming_msd12_msd26", "htiming_msd12_msd26", 3000, -1500, 1500); // 3000 channels, 1 ns per channel
		...
		{
			//lege_e = 0; lege_t = 0; north_e = 0; north_t = 0; south_e = 0; south_t = 0; msd12_e = 0; msd12_t = 0;
			msd26_e = 0; //msd26_t = 0;
