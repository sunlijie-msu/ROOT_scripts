...
{
	vector<double> Eg_values = { 1, 2, 3, 4, 5, 5.6, 6, 6.2, 7, 7.2, 8, 8.6, 9, 10, 11, 11.1, 11.2, 11.5, 12, 13, 14, 15, 16, 17, 18, 19, 20, 25, 30, 35, 40 };
	...
	for (size_t i = 0; i < Eg_values.size(); i++)
	{
		sprintf(rootname, "%sExG4_LowEnergy_%gkeV_all.root", pathname, Eg_values[i]);
